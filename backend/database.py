...
# Use Render's database URL or fallback to local development URL
DATABASE_URL = os.getenv("DATABASE_URL", "postgresql://postgres:Rainbows?13@localhost:5433/UserDB")
